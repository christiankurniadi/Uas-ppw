<?php
  ...
  $qry = mysqli_query($conn, "SELECT * FROM `tb_rokok` ");
?>
  ...
  <body>
            ...
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="#">Shop Cigarettes</a></li>
                </ul>
              </li>
              <li class="nav-item">
    ...
    <section class="vapes">
      ...
      <?php while ($result = mysqli_fetch_array($qry)) { ?> 
        ...
        <?php } ?>
        <!-- <div class="card" style="width: 18rem">
          <img src="https://github.com/christiankurniadi/keyboard-landing-page/blob/main/img/marlboro.jpg?raw=true" class="card-img-top" alt="..." />
          <div class="card-body">
            <h5 class="card-title">Marlboro</h5>
            <p class="card-text">Just a classic marlboro. What did you expect?</p>
          </div>
          <div class="card-body d-flex flex-column justify-content-center align-items-center gap-1">
            <a href="#" class="card-link card-btn">View product</a>
            <a href="#" class="card-link card-btn">Buy now</a>
        ...
        <div class="card" style="width: 18rem">
          <img src="https://github.com/christiankurniadi/keyboard-landing-page/blob/main/img/milang.jpg?raw=true" class="card-img-top" alt="..." />
          <div class="card-body">
            <h5 class="card-title">Milang</h5>
            <p class="card-text">Classy cigarettes for a classy people.</p>
          </div>
          <div class="card-body d-flex flex-column justify-content-center align-items-center gap-1">
            <a href="#" class="card-link card-btn">View product</a>
            <a href="#" class="card-link card-btn">Buy now</a>
        ...
        <div class="card" style="width: 18rem">
          <img src="https://github.com/christiankurniadi/keyboard-landing-page/blob/main/img/wildhemr.jpg?raw=true" class="card-img-top" alt="..." />
          <div class="card-body">
            <h5 class="card-title">Wildhemr</h5>
            <p class="card-text">Real definition of classy.</p>
          </div>
          <div class="card-body d-flex flex-column justify-content-center align-items-center gap-1">
            <a href="#" class="card-link card-btn">View product</a>
            <a href="#" class="card-link card-btn">Buy now</a>
        ...
        <div class="card" style="width: 18rem">
          <img src="https://github.com/christiankurniadi/keyboard-landing-page/blob/main/img/winston.jpg?raw=true" class="card-img-top" alt="..." />
          <div class="card-body">
            <h5 class="card-title">Winston</h5>
            <p class="card-text">This is a real deal tobacco.</p>
          </div>
          <div class="card-body d-flex flex-column justify-content-center align-items-center gap-1">
            <a href="#" class="card-link card-btn">View product</a>
            <a href="#" class="card-link card-btn">Buy now</a>
        ...
        <div class="card" style="width: 18rem">
          <img src="https://github.com/christiankurniadi/keyboard-landing-page/blob/main/img/anejados.jpg?raw=true" class="card-img-top" alt="..." />
          <div class="card-body">
            <h5 class="card-title">Anejados</h5>
            <p class="card-text">This is for real a tuff one.</p>
          </div>
          <div class="card-body d-flex flex-column justify-content-center align-items-center gap-1">
            <a href="#" class="card-link card-btn">View product</a>
            <a href="#" class="card-link card-btn">Buy now</a>
    ...
    <footer class="footer">
      <div class="container d-flex align-items-start justify-content-sm-between pt-5">
